...
UWAGA! Zanim przystąpisz do zmian w Pi-Star zrób aktualną kopię: _Pi-Star Dashboard -> Configuration -> Backup/Restore -> Download Configuration._<br>
...
Zaloguj się do Pi-Star Dashboard -> Configuration włącz M17 mode i przycisk Apply Changes.<br>
